...
if (!dbContent.includes('const sudafricaCards = [')) {
    ...
    console.log("Appended to tsubasa_cards.js");
}

const cardsPath = path.join(__dirname, 'cards.js');
let cardsContent = fs.readFileSync(cardsPath, 'utf8');

if (!cardsContent.includes('...sudafricaCards,')) {
    cardsContent = cardsContent.replace('...tailandiaCards,', '...tailandiaCards,\n    ...sudafricaCards,');
    fs.writeFileSync(cardsPath, cardsContent);
    console.log("Appended to cards.js");
}
