...
for (let line of lines) {
    ...
    let id = imageFile.toLowerCase() + "_realjapon"; // Just to make it unique if needed
...
const file = 'database/realjapon_cards.js';
const fileContent = `const realjaponCards = [\n${newCardsStr.replace(/,\n$/, '\n')}];\n`;

fs.writeFileSync(file, fileContent);
console.log('Created realjapon_cards.js');
